...
public class ResultURLModel implements Comparable<ResultURLModel>
{
   ...
   public ResultURLModel(int urlid, String url, int rank, String title, String desc)
   {
      this.setUrlid(urlid);
      this.setUrl(url);
      this.rank = rank;
   ...
   public ResultURLModel(int urlid, String url, int rank)
   {
      this.setUrlid(urlid);
      this.setUrl(url);
      this.rank = rank;
    ...
    */
   @Override
   public int compareTo(ResultURLModel arg0)
   {
