...
<div class="top-bar-black">
      <form name="ImageSearchTop" method="POST" action="/web/search" style="display:inline">
...
<div id="wrap">
   ...
   <div class=topbar id=TopBar>
      ...
      <form class="form-wrapper cf" method="post" name="search_frm"
         ...
         <div class="stub">   
   <form name="imageSearch" method="POST" action="/web/search" style="display:inline; margin-left: 160px; margin-right: -170px;">
         <input type="hidden" name="page" value="1"> <input
            type="hidden" value="<%=query.toString()%>" name="search_field"
            id="search_field"> <a
